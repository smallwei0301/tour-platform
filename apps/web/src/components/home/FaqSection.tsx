export function FaqSection() {
  const faqs = [
    { q: '什麼是私人嚮導行程？', a: '私人嚮導行程是由平台認證的在地嚮導帶領的小團體驗，行程由嚮導設計，旅客可以按照自己的節奏探索，不需要配合大團行程表。' },
    { q: '如何確保嚮導品質與安全？', a: '所有嚮導都經過實名認證（KYC），部分嚮導另有急救認證、環境教育講師等專業資歷。平台也提供緊急熱線 30 分鐘回應服務。' },
    ...
    { q: '如何成為嚮導？', a: '點擊「成為嚮導」填寫申請表，經過平台審核後即可上架行程。我們歡迎有在地特色、專業背景的嚮導加入。' },
  ];
