      ...
      {open && !value && (
        <div style={{
          ...
          {!loading && options.map(g => (
            ...
            >
              {g.profilePhotoUrl ? (
                <Image src={g.profilePhotoUrl} alt={g.displayName ?? '導遊頭像'} loading="lazy" style={{ width: 32, height: 32, borderRadius: '50%', objectFit: 'cover', flexShrink: 0 }} width={1200} height={675} />
              ) : (
