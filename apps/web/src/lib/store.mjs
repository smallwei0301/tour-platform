...
export const operationsTracking = [
  { orderId: 'ord_mock_001', orderDate: new Date(Date.now() - 3600000 * 2).toISOString(), guideName: 'Andy Lee', activityName: '高雄柴山探洞體驗', scheduleDate: '2026-04-01', travelers: 2, status: 'paid', gmv: 4000, commissionTwd: 600, paymentFeeTwd: 140, manualMinutes: 15, manualCostTwd: 75, refundAmountTwd: 0, subsidyTwd: 0, hasException: false, finalContributionTwd: 385, isHealthyOrder: true, isRescheduled: false, hasComplaint: false, hasGuideAdjustment: false, hasOversellIssue: false, note: null },
  { orderId: 'ord_mock_002', orderDate: new Date(Date.now() - 3600000 * 24).toISOString(), guideName: '陳建志', activityName: '大稻埕百年老街深度漫步', scheduleDate: '2026-04-02', travelers: 1, status: 'confirmed', gmv: 1500, commissionTwd: 225, paymentFeeTwd: 52, manualMinutes: 10, manualCostTwd: 50, refundAmountTwd: 0, subsidyTwd: 0, hasException: false, finalContributionTwd: 123, isHealthyOrder: true, isRescheduled: false, hasComplaint: false, hasGuideAdjustment: false, hasOversellIssue: false, note: null },
  { orderId: 'ord_mock_003', orderDate: new Date(Date.now() - 3600000 * 48).toISOString(), guideName: 'Andy Lee', activityName: '高雄柴山探洞體驗', scheduleDate: '2026-04-03', travelers: 3, status: 'refund_pending', gmv: 6000, commissionTwd: 900, paymentFeeTwd: 210, manualMinutes: 45, manualCostTwd: 225, refundAmountTwd: 6000, subsidyTwd: 0, hasException: true, finalContributionTwd: -5535, isHealthyOrder: false, isRescheduled: false, hasComplaint: false, hasGuideAdjustment: false, hasOversellIssue: false, note: '退款處理中' },
  { orderId: 'ord_mock_005', orderDate: new Date(Date.now() - 3600000 * 72).toISOString(), guideName: '陳建志', activityName: '大稻埕百年老街深度漫步', scheduleDate: '2026-04-02', travelers: 2, status: 'completed', gmv: 3000, commissionTwd: 450, paymentFeeTwd: 105, manualMinutes: 0, manualCostTwd: 0, refundAmountTwd: 0, subsidyTwd: 0, hasException: false, finalContributionTwd: 345, isHealthyOrder: true, isRescheduled: false, hasComplaint: false, hasGuideAdjustment: false, hasOversellIssue: false, note: null },
];
