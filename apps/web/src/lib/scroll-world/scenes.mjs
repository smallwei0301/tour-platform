/**
 * `/`（祕島世界 3D 滾動首頁）的場景註冊表（scroll-world 的 sections config 等價物）。
 *
 * 每景欄位：
...
export const SCROLL_WORLD_SCENES = [
  { id: 'intro', still: '/images/world/intro.webp', clip: '/videos/world/intro.mp4', accent: '#C2542E', href: '/home' },
  ...
  { id: 'finale', still: '/images/world/finale.webp', clip: '/videos/world/finale.mp4', accent: '#B08D3E', href: '/home' },
];
