...
export const activities: Activity[] = [
  {
    ...
    refundRules: ['活動 7 天前取消：100% 退款', '活動 3–7 天前取消：70% 退款', '活動 72 小時內取消：不退款', '若因導遊因素取消：全額退款'],
  ...
  },
  {
    ...
    refundRules: ['出團 7 天前取消：100% 退款', '出團前 3–7 天取消：70% 退款', '出團前 72 小時內取消：不退款', '不可抗力或主辦取消：100% 退款或 1 次免費改期'],
