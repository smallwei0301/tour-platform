...
export const guides: GuideProfile[] = [
  ...
  // #1475 商店頁示範嚮導：專供 Guide Shop 展示，3 個短標題行程（各 1 方案），
  // 對齊手機 mockup 圖2 的方案卡版面。台東為現行未被其他 fixture 佔用的地區，
  // 與既有嚮導/行程/地區列表完全隔離（append-only、不動中央示範資料）。
  {
    slug: 'wu-luo-ching',
    displayName: '吳洛晴',
    headline: '在台東的山與海之間，帶你走一條只有在地人才知道的徑。',
    shortBio: '我是吳洛晴，土生土長的台東人。比起熱門景點，我更想帶你走進晨霧裡的稜線、退潮後的祕境海灣，用在地的節奏，認識這片山海。',
    longBio: '我是吳洛晴，在台東出生長大，長期帶領山林健行、海岸生態與溯溪體驗。對我來說，台東最迷人的地方不是那些被拍爛的打卡點，而是清晨稜線上的霧、退潮後藏在礁岩間的小海灣、還有夜裡草原上滿天的星。我希望帶給旅人的不是趕場式的行程，而是一種放慢下來、真正走進山海節奏的方式。每一條路線我都會依當天的天氣、潮汐與同行者的狀態調整，安全永遠是第一位，但我保證你會帶走比想像中更多的風景與故事。',
    region: '台東',
    languages: ['中文', '英語', '日語'],
    specialties: ['山林健行', '海岸生態', '溯溪探險', '小團導覽'],
    verificationBadges: ['KYC 已驗證', '精選導遊', '野外急救認證'],
...
export const activities: Activity[] = [
  {
    ...
    refundRules: ['活動 168 小時前（含）取消：100% 退款', '活動 超過 72 小時且少於 168 小時取消：70% 退款', '活動 72 小時內（含）取消：不退款', '若因導遊因素取消：全額退款'],
  ...
  {
    slug: 'hualien-coastal-ecology-birdwatching',
    guideSlug: 'lin-a-ming',
    title: '花蓮東海岸潮間帶與賞鳥生態之旅',
    category: 'ecology',
    region: '花蓮縣',
    regionSlug: 'hualien',
    tagline: '走進潮間帶與海岸濕地，認識台灣東部的自然生態與在地野鳥。',
    shortDescription: '由在地嚮導林阿明帶你在退潮時走讀潮間帶生物，並用望遠鏡觀察海岸濕地的候鳥生態，慢慢看懂這片土地上的生命。',
    longDescription: '花蓮的海岸不只是拍照的背景。退潮後的潮間帶藏著寄居蟹、陽燧足與各種小生物，海岸濕地則是候鳥過境的重要驛站。林阿明會帶你放慢腳步，從一隻招潮蟹、一群水鳥開始，認識這片土地的生態節奏。不趕路、不打擾，低干擾地觀察而不帶走，是這趟行程最重要的原則。',
    price: 1600,
    priceLabel: 'NT$1,600 / 人',
    durationMinutes: 210,
    durationDisplay: '3.5 小時',
    minParticipants: 2,
    maxParticipants: 10,
    meetingPoint: '花蓮石梯坪遊客中心',
    meetingPointMapUrl: 'https://maps.google.com/?q=石梯坪',
    inclusions: ['生態嚮導全程帶領', '望遠鏡與圖鑑借用', '潮間帶導覽解說', '活動保險'],
    exclusions: ['交通費', '個人餐飲'],
    goodFor: ['喜歡自然觀察的旅客', '親子生態教育', '賞鳥與攝影愛好者'],
    notGoodFor: ['無法在戶外慢走 2 小時以上者'],
    notices: ['請穿防滑好走的鞋', '做好防曬防蚊', '依潮汐調整出發時間，導遊會提前確認'],
    refundRules: ['出團 168 小時前（含）取消：100% 退款', '出團前 超過 72 小時且少於 168 小時取消：70% 退款', '出團前 72 小時內（含）取消：不退款', '不可抗力或主辦取消：100% 退款或 1 次免費改期'],
    safetyNotice: '潮間帶岩石濕滑，請全程跟隨導遊並注意潮汐與海況。',
    faq: [
      { question: '沒有生態知識也能參加嗎？', answer: '可以，導遊會從零開始帶你認識，重點是慢慢看、好奇問，不需要任何背景。' },
      { question: '會看到哪些生物？', answer: '依季節與潮汐而定，常見招潮蟹、寄居蟹、陽燧足與多種海岸鳥類，導遊會視當天狀況解說。' },
    ],
    socialProofQuotes: ['第一次知道潮間帶這麼有趣', '導遊超會找鳥，望遠鏡裡看得好清楚', '帶小孩來最棒的自然課'],
    trustPoints: ['在地生態導覽經驗', '低干擾生態觀察原則', '潮汐與海況評估'],
    ...
    schedules: [
      { startAt: '2026-04-08T07:30:00+08:00', endAt: '2026-04-08T11:00:00+08:00', capacity: 10, bookedCount: 3, status: 'open' },
      { startAt: '2026-04-15T08:00:00+08:00', endAt: '2026-04-15T11:30:00+08:00', capacity: 10, bookedCount: 0, status: 'open' },
    ],
    transportMode: '步行',
  ...
  //   屏東縣（1 活動 1 方案，1 行標題）＋ 台東縣（1 活動 2 方案，2 行標題 → 2 卡）＝ 共 3 張卡片。
  {
    ...
    price: 1800,
    priceLabel: 'NT$1,800 / 人',
    durationMinutes: 240,
    durationDisplay: '約 4 小時',
    minParticipants: 2,
    maxParticipants: 8,
    meetingPoint: '台東鯉魚山登山口',
    meetingPointMapUrl: 'https://maps.google.com/?q=%E9%AF%89%E9%AD%9A%E5%B1%B1',
    inclusions: ['在地嚮導全程帶領', '路線與生態解說', '登山杖借用', '活動保險'],
    exclusions: ['個人交通費', '個人飲水與行動糧'],
    goodFor: ['喜歡清晨與自然的旅客', '想避開人潮的健行者', '攝影愛好者'],
    notGoodFor: ['無法早起出發者', '無法連續步行 2 小時以上者'],
    notices: ['請穿好走的登山鞋', '自備飲水與防曬', '天候不佳可能改期'],
    refundRules: ['出團 168 小時前（含）取消：100% 退款', '出團前 超過 72 小時且少於 168 小時取消：70% 退款', '出團前 72 小時內（含）取消：不退款', '不可抗力或主辦取消：100% 退款或 1 次免費改期'],
    safetyNotice: '本活動為戶外健行，請衡量自身體能並跟隨嚮導指示。',
    faq: [
      { question: '幾點出發？', answer: '通常清晨 5:30–6:00 於登山口集合，實際依季節日出時間調整，報名後會再確認。' },
      { question: '沒有健行經驗可以嗎？', answer: '可以，路線屬入門，重點在慢慢走、看風景，嚮導會控制節奏。' },
    ],
    socialProofQuotes: ['晨霧裡的稜線太美了', '第一次這麼早起，但完全值得', '嚮導很會找角度拍照'],
    trustPoints: ['台東在地嚮導', '野外急救認證', '小團慢節奏帶領'],
    ...
    plans: [
      { id: 'dawn-ridge-half-day', label: '半日健行', duration: '約 4 小時', priceType: 'per_person', basePrice: 1800, minParticipants: 2, maxParticipants: 8, highlights: ['晨霧稜線', '生態解說', '登山杖借用'], status: 'active' },
    ],
    schedules: [
      { startAt: '2026-07-11T05:30:00+08:00', endAt: '2026-07-11T09:30:00+08:00', capacity: 8, bookedCount: 2, status: 'open' },
      { startAt: '2026-07-18T05:30:00+08:00', endAt: '2026-07-18T09:30:00+08:00', capacity: 8, bookedCount: 0, status: 'open' },
    ],
    transportMode: '步行',
    seoTitle: '台東晨霧稜線健行｜清晨山林導覽｜吳洛晴',
    seoDescription: '清晨出發走上台東稜線，在晨霧散去前看光線喚醒山谷，由在地嚮導帶領的入門健行。',
  },
  {
    slug: 'taitung-secret-cove',
    guideSlug: 'wu-luo-ching',
    title: '祕境海灣浮潛｜退潮才現身的珊瑚礁灣',
    category: 'outdoor',
    region: '台東縣',
    regionSlug: 'taitung',
    tagline: '退潮後才會出現的小海灣，藏著整片珊瑚與魚群。',
    shortDescription: '走一小段礁岩，抵達退潮後才露出的祕境海灣，在清澈見底的水裡與魚群一起浮潛。全套裝備、專人帶領，新手也安心。',
    longDescription: '台東海岸線上，有些小海灣只有退潮後、又剛好知道路的人才進得去。我們會走一小段礁岩，抵達這片被岩石環抱的祕境海灣，在幾乎見底的清澈海水裡浮潛，看珊瑚與熱帶魚群就在腳邊游動。全程穿救生衣、由我在旁陪同，就算你是第一次浮潛也不用擔心。低干擾、不餵食、不觸碰，是我們對這片海的承諾。',
    price: 2200,
    priceLabel: 'NT$2,200 / 人',
    durationMinutes: 180,
    durationDisplay: '約 3 小時',
    minParticipants: 2,
    maxParticipants: 6,
    meetingPoint: '台東杉原海水浴場入口',
    meetingPointMapUrl: 'https://maps.google.com/?q=%E6%9D%89%E5%8E%9F%E6%B5%B7%E6%B0%B4%E6%B5%B4%E5%A0%B4',
    inclusions: ['浮潛全套裝備（面鏡、呼吸管、救生衣、防寒衣）', '專人帶領與安全戒護', '海灣生態解說', '活動保險'],
    exclusions: ['個人交通費', '毛巾與換洗衣物', '防水手機袋'],
    goodFor: ['想看珊瑚與魚群的旅客', '喜歡海邊的親子與朋友', '浮潛新手'],
    notGoodFor: ['極度恐水者', '嚴重心血管疾病患者'],
    notices: ['請自備泳衣與毛巾', '出發前請勿飲酒', '依潮汐與海況調整時間'],
    refundRules: ['出團 168 小時前（含）取消：100% 退款', '出團前 超過 72 小時且少於 168 小時取消：70% 退款', '出團前 72 小時內（含）取消：不退款', '不可抗力或主辦取消：100% 退款或 1 次免費改期'],
    safetyNotice: '浮潛為水域活動，請衡量健康狀況並全程跟隨嚮導與穿著救生衣。',
    faq: [
      { question: '不會游泳可以參加嗎？', answer: '可以，全程穿救生衣並由嚮導在旁陪同，但若極度恐水建議先評估。' },
      { question: '需要自己帶裝備嗎？', answer: '不用，浮潛裝備全套提供，你只需準備泳衣與毛巾。' },
    ],
    socialProofQuotes: ['水清到像玻璃', '魚群就在腳邊', '嚮導很細心，全程很安心'],
    trustPoints: ['台東在地嚮導', '野外急救認證', '低干擾海洋守則'],
    ...
    schedules: [
      ...
      { startAt: '2026-07-19T09:00:00+08:00', endAt: '2026-07-19T12:00:00+08:00', capacity: 6, bookedCount: 0, status: 'open' },
    ],
    transportMode: '步行',
