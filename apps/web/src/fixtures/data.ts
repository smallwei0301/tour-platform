...
export const activities: Activity[] = [
  {
    ...
    refundRules: ['活動 168 小時前（含）取消：100% 退款', '活動 72 小時以上且少於 168 小時取消：70% 退款', '活動 72 小時內（含）取消：不退款', '若因導遊因素取消：全額退款'],
  ...
  },
  {
    ...
    refundRules: ['出團 168 小時前（含）取消：100% 退款', '出團前 72 小時以上且少於 168 小時取消：70% 退款', '出團前 72 小時內（含）取消：不退款', '不可抗力或主辦取消：100% 退款或 1 次免費改期'],
