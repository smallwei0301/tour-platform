    ...
    <main className="kkd-detail-page" style={{ paddingBottom: 100 }}>
      ...
      <div className="tp-container">
        <div className="kkd-title-block">
          {/* Badges */}
          <div className="kkd-badge-row">
            <span className="kkd-badge">✅ 認證導遊</span>
            <span className="kkd-badge">🕐 {activity.durationDisplay}</span>
            <span className="kkd-badge">
              {activity.transportMode === '步行' ? '🚶' : '🚐'} {activity.transportMode}
            </span>
            <span className="kkd-badge">
          ...
          {/* Policy row — transparent bg, black SVG icons */}
