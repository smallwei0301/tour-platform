/**
 * #1649 Phase 6：實作自 legacy 路徑（app/api/admin/orders/[orderId]/refund-override）整體搬遷至 v2 命名空間。
...
export async function POST(
  ...
  try {
    ...
    void reportRouteError(err, { route: 'v2/admin/orders/[orderId]/refund-override' });
