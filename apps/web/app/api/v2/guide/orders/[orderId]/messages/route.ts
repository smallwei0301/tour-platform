/**
 * /api/v2/guide/orders/[orderId]/messages — #1649 Phase 4 v2 命名空間接線。
 *
...
import { POST as legacyPOST } from '../../../../../guide/orders/[orderId]/messages/route';
export { GET } from '../../../../../guide/orders/[orderId]/messages/route';
