/**
 * #1649 Phase 6：實作自 legacy 路徑（app/api/guide/bookings/[bookingId]/approval）整體搬遷至 v2 命名空間。
...
export async function POST(
  ...
  try {
    ...
    void reportRouteError(error, { route: 'v2/guide/bookings/[bookingId]/approval' });
