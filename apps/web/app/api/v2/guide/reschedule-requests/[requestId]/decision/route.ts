/**
 * /api/v2/guide/reschedule-requests/[requestId]/decision — #1649 Phase 4 v2 命名空間接線。
 *
...
import { POST as legacyPOST } from '../../../../../guide/reschedule-requests/[requestId]/decision/route';
