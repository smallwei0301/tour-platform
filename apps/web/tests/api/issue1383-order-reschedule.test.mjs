...
// 把 fixture 場次推到未來，避免 168h（7 天）窗口擋住（fixture 日期為 2026-04，已過）
...
test('窗外（<168h）申請 → RESCHEDULE_WINDOW_CLOSED', async () => {
  makeFuture('sch_chaishan_0403', 12, { resetBooked: true });
  const from = makeFuture('sch_chaishan_0410', 1); // 24h 後開始，遠在 168h 窗內
