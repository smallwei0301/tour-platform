...
test('GH-927 truth-table: stale/mismatched scheduleId fallback keeps generated path available', () => {
  const out = evaluate({
    ...
    selectedSchedule: {
      ...
      activity_id: 'a-1',
      plan_id: 'p-1',
      start_at: '2037-07-01T10:00:00+08:00',
      end_at: '2037-07-01T12:00:00+08:00',
      capacity: 6,
      booked_count: 0,
      status: 'open',
    },
    ...
    blackouts: [
      {
        id: 'b-1',
        guide_id: 'g-1',
        starts_at: '2037-07-01T00:00:00+08:00',
        ends_at: '2037-07-01T23:59:59+08:00',
        reason: 'guide off',
        source: 'manual',
      },
    ],
    ...
    bookings: [
      {
        ...
        guide_id: 'g-1',
        start_at: '2037-07-01T07:00:00+08:00',
        end_at: '2037-07-01T08:00:00+08:00',
        status: 'draft',
        participants: 5,
        activity_id: 'a-1',
        activity_plan_id: 'p-1',
    ...
    bookings: [
      {
        ...
        guide_id: 'g-1',
        start_at: '2037-07-01T08:00:00+08:00',
        end_at: '2037-07-01T09:00:00+08:00',
        status: 'draft',
        participants: 2,
        activity_id: 'a-1',
        activity_plan_id: 'p-1',
