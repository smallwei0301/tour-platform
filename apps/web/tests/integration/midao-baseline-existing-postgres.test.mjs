...
test('existing rehearsal keeps 128 occupied cutoff records and applies only six post-cutoff versions', async () => {
  ...
  assert.deepEqual(rows.slice(-6).map(({ version }) => version), postVersions);
