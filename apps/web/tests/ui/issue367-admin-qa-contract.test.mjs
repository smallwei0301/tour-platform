 ...
 *
 * AC1: app/admin/qa/page.tsx exists, references /api/admin/qa, shows activity_id/question/status
...
test('AC1: app/admin/qa/page.tsx exists and is non-empty', async () => {
  const src = await readSource('app/admin/qa/page.tsx');
