...
test('GH-860 contract: step2 creates draft before payment step and carries activeScheduleId', async () => {
  ...
  assert.match(src, /activeScheduleId:\s*activeScheduleId\s*\|\|\s*undefined/, 'draft payload should include activeScheduleId when available');
