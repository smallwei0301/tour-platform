...
## Audio direction
- Role: cinematic 低限氛圍 bed（破曉山風＋低頻 drone），非節奏型
- Music: 自製 `assets/audio/bed.mp3`（98/147Hz 五度 drone + pink-noise 山風 + 緩起緩落 + 空間殘響）。bundled「business moves」上揚節奏與品牌衝突，故不用。
