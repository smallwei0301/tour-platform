...
**Generated/updated by one guarded local publication transaction:**
...
Expected：兩個clean local runs terminal catalog byte-identical，history exact；同一guarded transaction產生catalog、digest、final manifest並更新ledger，全部read-back PASS後才promotion；cleanup PASS。
