...
**Run the evals**: after any rule change, run the relevant scenarios in [evals.md](references/evals.md) and record the results there. Captured failures with their before/after receipts live in [worked-examples.md](references/worked-examples.md) — add new captures in the same format.
...
- any new or changed rule survived a RED-GREEN subagent test, with the baseline behavior documented in [evals.md](references/evals.md)
